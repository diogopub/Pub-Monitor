    ...
    >
      ...
      >
        {pinLabels.map((lab, index) => {
          ...
          const baseClasses = "w-full h-auto min-h-[24px] py-1 px-1 text-[9.5px] md:text-[9.5px] shadow-md border rounded text-center focus:ring-0 whitespace-normal leading-tight font-bold font-heading uppercase tracking-wider transition-all";
